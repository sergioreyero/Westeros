...
final class LocalFactory: SeasonFactory {
    ...
    var seasons: [Season] {
        ...
        //06-04-2014
        let season4 = Season(name: "Season 4", startDate: Date(timeIntervalSinceReferenceDate: 384700000))
        let e1s4 = Episode(title: "Two Swords", launchDate: Date(timeIntervalSinceReferenceDate: 384700000), season: season1)
        let e2s4 = Episode(title: "The Lion and the Rose", launchDate: Date(timeIntervalSinceReferenceDate: 384750000), season: season1)
        
        //12-04-2015
        let season5 = Season(name: "Season 5", startDate: Date(timeIntervalSinceReferenceDate: 384700000))
        let e1s5 = Episode(title: "The Wars to Come", launchDate: Date(timeIntervalSinceReferenceDate: 384700000), season: season1)
        let e2s5 = Episode(title: "The House of Black and White", launchDate: Date(timeIntervalSinceReferenceDate: 384750000), season: season1)
        
        //24-04-2016
        let season6 = Season(name: "Season 6", startDate: Date(timeIntervalSinceReferenceDate: 384700000))
        let e1s6 = Episode(title: "The Red Woman", launchDate: Date(timeIntervalSinceReferenceDate: 384700000), season: season1)
        let e2s6 = Episode(title: "Home", launchDate: Date(timeIntervalSinceReferenceDate: 384750000), season: season1)
        
        //16-07-2017
        let season7 = Season(name: "Season 7", startDate: Date(timeIntervalSinceReferenceDate: 384700000))
        let e1s7 = Episode(title: "Dragonstone", launchDate: Date(timeIntervalSinceReferenceDate: 384700000), season: season1)
        let e2s7 = Episode(title: "Stormborn", launchDate: Date(timeIntervalSinceReferenceDate: 384750000), season: season1)
